		...
		<div>
			...
			<div class="main-content">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<form id="updateForm" class="form-horizontal" role="form" action="<%=path%>/updateShop" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="shopName" class="col-xs-10 col-sm-4" name="shopName" value="${shop.shopName}"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="shopFee" class="col-xs-10 col-sm-4" name="shopFee" value="${shop.shopFee}"/>
									</div>
								</div>
			...
			rules : {
				shopName : {
					...
					remote:{
			               ...
			               data:{ shopId  : function() { return $("#shopId").val(); },
			            	      shopName: function() { return $("#shopName").val(); }} 
					}
				},
				shopFee : {
					required : true,
