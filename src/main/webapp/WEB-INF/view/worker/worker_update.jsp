		...
		<div>
			...
			<div class="main-content">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<form id="updateForm" class="form-horizontal" role="form" action="<%=path%>/updateWorker" method="post">
								<input type="hidden" id="workerNumber" name="workerNumber" value="${worker.workerNumber}"/>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="workerNumber"> 工号</label>
									<div class="col-sm-9">
										<input type="text" disabled="true" class="col-xs-10 col-sm-4" value="${worker.workerNumber}"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="workerName" class="col-xs-10 col-sm-4" name="workerName" value="${worker.workerName}"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="phone" class="col-xs-10 col-sm-4" name="phone" value="${worker.phone}"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="remark" class="col-xs-10 col-sm-4" name="remark" value="${worker.remark}"/>
									</div>
								</div>
